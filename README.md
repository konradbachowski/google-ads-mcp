...
Professional keyword research tool integrated with Claude AI via Model Context Protocol (MCP).

Get real search volumes, competition data, and CPC estimates directly from Google Ads API - no guessing, no scraping, just official data.
...
- **`list_available_locations`** - See all supported countries
- **`list_available_languages`** - See all supported languages
